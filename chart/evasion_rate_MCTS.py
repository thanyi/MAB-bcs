...
def main():
    ...
    y1_list_rate, _ = get_from_log('/home/wei/code/MAB-malware/MCTS.rewriter.log', r1)
    ...
    y3_list_rate, total = get_from_log('/home/wei/code/MAB-malware/MCTS.rewriter2.log', r3)
