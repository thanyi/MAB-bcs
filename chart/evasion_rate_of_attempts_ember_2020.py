...
def main():
    ...
    y1_list_rate, _ = get_from_log('/home/wei/code/adversarial_malware/final_output/our/ember_2020/output_' + av + '_holdout_random/rewriter.log', r1)
    #y2_list_rate, _ = get_from_log('/home/wei/code/adversarial_malware/final_output/our/output_' + av + '_1000_TS/rewriter.log', r2)
    y3_list_rate, total = get_from_log('/home/wei/code/adversarial_malware/final_output/our/ember_2020/output_' + av + '_holdout_TS_parent/rewriter.log', r3)
    ...
    plt.annotate(str(y3_list_rate[-1]), (total,y3_list_rate[-1]+1), color='red', textcoords="offset points", xytext=(15,0), ha='center', fontsize=9)
