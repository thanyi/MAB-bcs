...
def main():
    ...
    y1_list_rate, _ = get_from_log('/home/wei/code/adversarial_malware/final_output/our/malconv/output_' + av + '_holdout_random/rewriter.log', r1)
    ...
    y3_list_rate, total = get_from_log('/home/wei/code/adversarial_malware/final_output/our/malconv/output_' + av + '_holdout_TS_parent/rewriter.log', r3)
    ...
    plt.annotate(str(y3_list_rate[-1]), (total,y3_list_rate[-1]-3), color='red', fontsize=9)
